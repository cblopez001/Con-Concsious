...
function addToCartClicked(event) {
    ...
    var price = shopItem.getElementsByClassName('card-subtitle')[0].innerText
...
function addItemToCart(title, price, imageSrc) {
    ...
    <div class="cart-item cart-column">
      <img src=${imageSrc} width="100" height="100" class="cart-item-img">
      <span class="cart-item-title">${title}</span>
    </div>
    <span class="cart-price cart-column">${price}</span>
  <div class="cart-quantity cart-column">
    <input type="number" name="" id="" value="1" class="quantity-input">
    <button role="button" class="btn btn-danger quantity-btn">REMOVE</button>
  </div>`
